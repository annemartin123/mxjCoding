...
table_skuTask='skuTask'#'jd_tiemo'
table_sortTask='sortTask'

sql_childTask="page int(11), link varchar(255), status int(11), kind varchar(255), website varchar(255), firstTime DateTime, lastTime DateTime, primary key(page)"
sql_skuTask = "sku varchar(255), title varchar(255), shopId varchar(255), shopName varchar(255), kind varchar(255), website varchar(255), firstTime DateTime, lastTime DateTime, primary key(sku)"
sql_sortTask = "sku varchar(255), title varchar(255), shopId varchar(255), shopName varchar(255), kind varchar(255), website varchar(255), sort int(11), number int(11), firstTime DateTime, lastTime DateTime,primary key(sku, sort)"
